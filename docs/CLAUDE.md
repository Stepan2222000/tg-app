...
ОБЯЗАТЕЛЬНО НАДО ПЕРЕОДИЧЕСКИ ОБНОВЛЯТЬ И ДОБАВЛЯТЬ ИНФОРМАЦИЮ В ФАЙЛ CLAUDE.md И СМОТРЕТЬ ЗА ТЕМ, ЧТО ИСФОРМАЦИЯ НЕ ПРОТИВОРЕЧИТ РЕАЛЬНОСТИ И ПРОЧИМ ДОКУМЕНТАЦИЯМ

СЮДА ДОЛЖНА ДОБАВЯТЬСЯ ИНФОРМАЦИЯ ПО ПРОЕКТУ
