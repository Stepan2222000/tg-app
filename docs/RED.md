...
Проект разработан по принципу KISS (Keep It Simple, Stupid) - максимальная простота для быстрого запуска MVP, без сложных проверок и автоматизаций на первом этапе.